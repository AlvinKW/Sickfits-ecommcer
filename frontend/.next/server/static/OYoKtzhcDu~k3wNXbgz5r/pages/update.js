...
var SINGLE_ITEM_QUERY = external_graphql_tag_default()(_templateObject()); // Mutation Query

var UPDATE_ITEM_MUTATION = external_graphql_tag_default()(_templateObject2());

var UpdateItem_UpdateItem = /*#__PURE__*/function (_Component) {
  ...
  function UpdateItem() {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateItem", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee(e, updateItemMutation) {
        var res;
  ...
  _createClass(UpdateItem, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        if (!data.item) return /*#__PURE__*/external_react_default.a.createElement("p", null, "No Item Found For ID ", _this2.props.id);
...
var update_Sell = function Sell(_ref) {
  var query = _ref.query;
  return /*#__PURE__*/external_react_default.a.createElement("div", null, /*#__PURE__*/external_react_default.a.createElement(components_UpdateItem, {
    id: query.id
  }));
};

/* harmony default export */ var update = __webpack_exports__["default"] = (update_Sell);
